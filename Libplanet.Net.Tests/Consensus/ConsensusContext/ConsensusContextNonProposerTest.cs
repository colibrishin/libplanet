...
namespace Libplanet.Net.Tests.Consensus.ConsensusContext
{
    ...
    public class ConsensusContextNonProposerTest
    {
        ...
        public async void HandleMessageFromHigherHeight()
        {
            ...
            _logger.Debug(
                "EndCommit: {EndTime}, ProposeTime: {ProposeTime}, Difference: {Difference}",
                heightTwoEndTimestamp,
                heightThreeStartTimestamp,
                heightTwoEndTimestamp - heightThreeStartTimestamp);
            Assert.True(
