...
namespace Libplanet.Crypto.Common
{
    ...
    {
        private readonly Secp256K1CryptoBackend<SHA256> _backend = new Secp256K1CryptoBackend<SHA256>();
        ...
        /// <see cref="System.Security.Cryptography.X509Certificates.PublicKey"/> constructor whether it is compressed
        /// or not.</returns>
