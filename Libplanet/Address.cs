...
namespace Libplanet
{
    ...
    public readonly struct Address : ISerializable, IComparable<Address>, IComparable
    {
        ...
        /// <see cref="AddressExtensions.ToAddress(IECPublicKey)"/>, which enables
        ...
        /// <seealso cref="AddressExtensions.ToAddress(IECPublicKey)"/>
        public Address(IECPublicKey publicKey)
        ...
        private static byte[] DeriveAddress(IECPublicKey key)
        {
