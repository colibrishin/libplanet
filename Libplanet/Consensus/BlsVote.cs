...
namespace Libplanet.Consensus
{
    ...
    /// </summary>
    public readonly struct BlsVote : IEquatable<BlsVote>
    {
        ...
        public BlsVote(byte[] marshaled)
        {
            ...
            try
            {
                ...
                Validator = new BlsPublicKey(
                    dict.GetValue<Binary>(ValidatorKey).ByteArray);
        ...
        public byte[] ByteArray
        {
            get
            {
                ...
                var dict = Bencodex.Types.Dictionary.Empty
                    ...
                    .Add(ValidatorKey, Validator.ToByteArray())
        ...
        public BlsVote RemoveSignature =>
            new BlsVote(Height, Round, BlockHash, Timestamp, Validator, Flag, null);
        ...
        /// <c>null</c>.</exception>
        public BlsVote Sign(BlsPrivateKey signer)
        {
            BlsVote voteWithoutSign = RemoveSignature;
        ...
        public bool Equals(BlsVote other)
        {
