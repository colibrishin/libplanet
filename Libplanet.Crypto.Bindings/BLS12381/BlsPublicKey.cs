...
namespace Libplanet.Crypto.Bindings.BLS12381
{
    ...
    public class BlsPublicKey : IEquatable<BlsPublicKey>, IPublicKey
    {
        ...
        public BlsPublicKey(IReadOnlyList<byte> publicKey)
        {
            ...
            _ = BlsCryptoNativeBackend<SHA256>.ValidateGetNativePublicKey(this);
        }
        ...
        public bool VerifyProofOfPossession(BlsSignature proofOfPossession) =>
            BlsCryptoNativeBackend<SHA256>.VerifyPoP(this, proofOfPossession);
        ...
        /// recovered to a <see cref="Planetarium.Cryptography.BLS12_381.PublicKey"/> instance again using
        ...
        public bool Verify(IReadOnlyList<byte> message, IReadOnlyList<byte> signature)
        {
            ...
            return _backend.Verify(hashed, signature.ToArray(), this);
        }
