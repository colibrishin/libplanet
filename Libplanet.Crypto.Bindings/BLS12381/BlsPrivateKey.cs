...
namespace Libplanet.Crypto.Bindings.BLS12381
{
    ...
    {
        private readonly BlsCryptoBackend<SHA256> _backend = new BlsCryptoBackend<SHA256>();
        ...
        {
            _privateKey = BlsCryptoNativeBackend<SHA256>.GeneratePrivateKey()
                .ToImmutableArray();
            _proofOfPossession = BlsCryptoNativeBackend<SHA256>.GetProofOfPossession(this);
        }
        ...
        public BlsPrivateKey(IReadOnlyList<byte> privateKey)
        {
            ...
            _ = BlsCryptoNativeBackend<SHA256>.ValidateGetNativePrivateKey(this);
            _proofOfPossession = BlsCryptoNativeBackend<SHA256>.GetProofOfPossession(this);
        }
        ...
        public BlsPublicKey PublicKey
        {
            get
            {
                ...
                {
                    _publicKey = BlsCryptoNativeBackend<SHA256>.GetPublicKey(this);
                }
        ...
        public BlsSignature ProofOfPossession
        {
            get
            {
                ...
                {
                    _proofOfPossession =
                        BlsCryptoNativeBackend<SHA256>.GetProofOfPossession(this);
                }
        ...
        public byte[] Sign(byte[] message)
        {
            ...
            return _backend.Sign(hashed, this);
        }
