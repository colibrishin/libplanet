...
namespace Libplanet.Crypto.Bindings.BLS12381
{
    ...
    public sealed class BlsSignature : IEquatable<BlsSignature>
    {
        ...
        public BlsSignature(IReadOnlyList<byte> signature)
        {
            ...
            _ = BlsCryptoNativeBackend<SHA256>.ValidateGetNativeSignature(ToByteArray());
        }
            ...
            BlsSignature[] signatures, BlsPublicKey[] publicKeys, IReadOnlyList<byte>[] messages)
        {
            ...
            return BlsCryptoNativeBackend<SHA256>.MultiVerify(signatures, publicKeys, hashes);
        }
        ...
        public bool FastAggregateVerify(BlsPublicKey[] publicKeys, IReadOnlyList<byte> message)
        {
            ...
            return BlsCryptoNativeBackend<SHA256>.FastAggregateVerify(this, publicKeys, hashed);
        }
        ...
        public bool AggregateVerify(BlsPublicKey[] publicKeys, IReadOnlyList<byte>[] messages)
        {
            ...
            return BlsCryptoNativeBackend<SHA256>.AggregateVerify(this, publicKeys, hashes);
        }
